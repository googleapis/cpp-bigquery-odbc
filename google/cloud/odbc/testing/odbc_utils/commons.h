...
struct StructBasicTestStruct {
  ...
  std::optional<SQL_DATE_STRUCT> date;
  std::optional<SQL_TIME_STRUCT> time;
  std::optional<SQL_INTERVAL_STRUCT> interval_year_month;
  std::optional<nlohmann::json> json_field;
