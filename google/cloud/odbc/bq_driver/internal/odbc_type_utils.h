...
inline odbc_internal::StatusRecord IntervalTOutputBufferResponse(const SQL_INTERVAL_STRUCT& conn_interval,
                                  SQLPOINTER dest_buf, SQLLEN buffer_length, SQLLEN* result_len){
...
inline odbc_internal::StatusRecord STinyIntToOutputBufferResponse(SQLUINTEGER value,
                               int8_t* dest, SQLLEN* result_len){
    auto status_record = odbc_internal::StatusRecord::Ok();
    ...
    odbc_internal::StatusRecord{
            odbc_internal::SQLStates::k_22003(), "Interval data, right truncated"};  
    return status_record;                          
}
}  // namespace google::cloud::odbc_bq_driver_internal
