...
class DriverForm {
 public:
  ...
  inline std::string const& GetLogLevel() const {return LogTraceDialog::log_level_;}
  inline std::string const& GetLogFilePath() const { return LogTraceDialog::log_file_path_;}
