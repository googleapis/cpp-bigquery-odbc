...
void LogTraceDialog::InitControls() {
  ...
  HWND h_group_box = CreateWindowEx(
      0, "BUTTON", "Log rotation", WS_CHILD | WS_VISIBLE | BS_GROUPBOX,
      KAxisX - 10, KLabelWidth + 5, 427, 75, parent_hwnd, (HMENU)kIdcGroupBox,
  ...
  HWND h_max_files_edit = CreateWindowEx(
      WS_EX_CLIENTEDGE, "EDIT", "50",
      WS_CHILD | WS_VISIBLE | WS_TABSTOP | ES_NUMBER |
          ES_RIGHT,  // Added ES_RIGHT
      KAxisX + 205, KAxisY + 95, kEditBoxWidth, kEditBoxHeight, parent_hwnd,
      (HMENU)kIdcMaxFilesEdit, GetModuleHandle(NULL), NULL);
  ...
  HWND h_max_size_edit = CreateWindowEx(
      WS_EX_CLIENTEDGE, "EDIT", "20",
      WS_CHILD | WS_VISIBLE | WS_TABSTOP | ES_NUMBER |
          ES_RIGHT,  // Added ES_RIGHT
      KAxisX + 205, KAxisY + 125, kEditBoxWidth, kEditBoxHeight, parent_hwnd,
      (HMENU)kIdcMaxSizeEdit, GetModuleHandle(NULL), NULL);
