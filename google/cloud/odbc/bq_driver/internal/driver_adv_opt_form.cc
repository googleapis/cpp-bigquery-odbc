...
void AdvanceOptions::CreateLargeResultsControls(HFONT h_font) {
  HWND h_large_results_header = CreateWindowEx(
      ...
      kXAxis, kYAxis + 25, kWidth + 385, kHeight + 153, adv_hwnd,
      (HMENU)KIdcLargeResultHeader, GetModuleHandle(NULL), NULL);
...
void AdvanceOptions::CreateAdditionalControls(HFONT h_font) {
  ...
  HWND h_hyperlink = CreateWindowEx(
      ...
      144, kButtonY + 10, kWidth + 100, kHeight, adv_hwnd, (HMENU)kIdcHyperlink,
