...
StatusRecordOr<std::string> Utf16ToUtf8(
...
StatusRecordOr<std::wstring> Utf8ToUtf16(
...
StatusRecordOr<std::string>
ConvertSQLWCHARToString(SQLWCHAR* in_str, SQLINTEGER in_str_len) {
  if (in_str == nullptr) {
