...
#ifndef GOOGLE_CLOUD_ODBC_BQ_DRIVER_INTERNAL_SETENV_H
#define GOOGLE_CLOUD_ODBC_BQ_DRIVER_INTERNAL_SETENV_H
...
#endif  // GOOGLE_CLOUD_ODBC_BQ_DRIVER_INTERNAL_SETENV_H
