...
StatusRecordOr<std::string> ConvertFromCharBuffer(
  ...
  switch (sql_type) {
    ...
    default: {
      ...
      if(!double_status) {
        // If `src_str` cannot be converted to double, it is not an arithmetic value
        return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
      }
      auto conv_status = ConvertFromArithmeticValue<SQLDOUBLE>(*double_status, sql_type);
      if (!conv_status) {
...
StatusRecordOr<std::string> ConvertFromBuffer(
    DataBuffer& src_data, SQLSMALLINT sql_type) {
  SQLSMALLINT src_type = src_data.type;
  SQLPOINTER src_buf = src_data.buf;
  ...
  switch (src_type) {
    ...
    case SQL_C_DOUBLE: {
      ...
      auto conv_status = ConvertFromArithmeticValue<SQLDOUBLE>(src_val, sql_type);
      if (!conv_status) {
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    ...
    case SQL_C_SBIGINT: {
      ...
      auto conv_status = ConvertFromArithmeticValue<SQLBIGINT>(src_val, sql_type);
      if (!conv_status) {
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    ...
    case SQL_C_UBIGINT: {
      ...
      auto conv_status = ConvertFromArithmeticValue<SQLUBIGINT>(src_val, sql_type);
      if (!conv_status) {
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    ...
    case SQL_C_SSHORT: {
      ...
      auto conv_status = ConvertFromArithmeticValue<SQLSMALLINT>(src_val, sql_type);
      if (!conv_status) {
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    ...
    case SQL_C_USHORT: {
      ...
      auto conv_status = ConvertFromArithmeticValue<SQLUSMALLINT>(src_val, sql_type);
      if (!conv_status) {
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    ...
    case SQL_C_SLONG: {
      ...
      auto conv_status = ConvertFromArithmeticValue<SQLINTEGER>(src_val, sql_type);
      if (!conv_status) {
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    ...
    case SQL_C_ULONG: {
      ...
      auto conv_status = ConvertFromArithmeticValue<SQLUINTEGER>(src_val, sql_type);
      if (!conv_status) {
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
