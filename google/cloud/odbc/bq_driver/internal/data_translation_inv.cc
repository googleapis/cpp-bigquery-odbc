  ...
  switch (src_data.type) {
    ...
    case SQL_C_WCHAR: {
      ...
      if ((result_len > 0) || (result_len == SQL_NTS)) {
        ...
        if (!utf8_res) {
          LOG(ERROR) << "ConvertFromCharBuffer::ConvertSQLWCHARToString:: UTF-8 conversion failed ";
  ...
  switch (sql_type) {
    ...
    default: {
      ...
      if (!double_status) {
        ...
        // value
        LOG(ERROR) << "ConvertFromCharBuffer::ConvertToDouble:: Conversion is unsupported";
        return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
      }
  ...
  switch (sql_type) {
    ...
    case SQL_BIT: {
      if (*double_val != 0 && *double_val != 1) {
        LOG(ERROR) << "ConvertFromNumericBuffer:: Invalid BIT value (must be 0 or 1): " << *double_val;
    ...
    default:
      LOG(WARNING) << "ConvertFromNumericBuffer:: Conversion is unsupported for SQL type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromBinaryBuffer(DataBuffer& src_data,
  ...
  if (!src_val || !src_result_len || *src_result_len < 0) {
    LOG(ERROR) << "ConvertFromBinaryBuffer:: Invalid source buffer or result length";
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromBinaryBuffer:: Conversion is unsupported for SQL type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromBitBuffer(DataBuffer src_data,
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromBitBuffer:: Conversion is unsupported for SQL type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromDateBuffer(DataBuffer src_data,
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromDateBuffer:: Conversion is unsupported for SQL type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromTimeBuffer(DataBuffer& src_data,
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromTimeBuffer:: Conversion is unsupported for SQL type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
  ...
  switch (sql_type) {
    ...
    case SQL_INTERVAL_DAY_TO_HOUR: {
      if (interval_struct.interval_type != SQL_IS_DAY_TO_HOUR) {
        return StatusRecord{SQLStates::k_HY000(), "Invalid Day To Hour Interval value"};
        return StatusRecord{SQLStates::k_HY000(),
    ...
    default:
      LOG(WARNING) << "ConvertFromIntervalBuffer:: Conversion is unsupported for SQL type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromTimestampBuffer(DataBuffer& src_data,
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromTimestampBuffer:: Conversion is unsupported for SQL type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromBuffer(DataBuffer& src_data,
  ...
  switch (src_data.type) {
    ...
    case SQL_C_FLOAT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
