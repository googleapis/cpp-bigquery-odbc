  ...
  switch (src_data.type) {
    ...
    case SQL_C_WCHAR: {
      ...
      if ((result_len > 0) || (result_len == SQL_NTS)) {
        ...
        if (!utf8_res) {
           LOG(ERROR) << "ConvertFromCharBuffer::ConvertSQLWCHARToString:: " << utf8_res.GetStatusRecord().message;
          return utf8_res.GetStatusRecord();
        }
        src_str = *utf8_res;
        break;
      }
      LOG(WARNING) << "ConvertFromCharBuffer::Invalid buffer length: " << result_len;
      return StatusRecord{SQLStates::k_HY000(), "Invalid buffer length"};
    }
    default: {
      LOG(WARNING) << "ConvertFromCharBuffer::Conversion is unsupported for C-type: " << src_data.type;
  ...
  switch (sql_type) {
    ...
    default: {
      ...
      if (!double_status) {
        ...
        // value
        LOG(ERROR) << "ConvertFromCharBuffer::ConvertToDouble:: " << double_status.GetStatusRecord().message;
        return double_status.GetStatusRecord();
      }
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromCharBuffer::ConvertFromArithmeticValue:: " << conv_status.GetStatusRecord().message;
...
StatusRecordOr<std::string> ParseIntervalToBuffer(SQLSMALLINT type,
  ...
  switch (type) {
    ...
    default:
      LOG(WARNING) << "ParseIntervalToBuffer::invalid single-field interval type: " << type;
...
StatusRecordOr<std::string> ConvertFromNumericBuffer(DataBuffer src_data,
  ...
  if (!double_val) {
    LOG(ERROR) << "ConvertFromNumericBuffer::ConvertToDouble:: " << double_val.GetStatusRecord().message;
  ...
  switch (sql_type) {
    ...
    case SQL_LONGVARCHAR: {
      if (src_str.length() > src_data.buflen) {
        LOG(WARNING) << "ConvertFromNumericBuffer::String data, right truncated.";
    ...
    case SQL_FLOAT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromNumericBuffer::ConvertFromArithmeticValue:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    ...
    case SQL_BIT: {
      if (*double_val != 0 && *double_val != 1) {
        LOG(ERROR) << "ConvertFromNumericBuffer::Bit value out of range: " << *double_val;
    ...
    default:
    LOG(WARNING) << "ConvertFromNumericBuffer::Conversion is unsupported for sql_type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromBinaryBuffer(DataBuffer& src_data,
  ...
  if (!src_val || !src_result_len || *src_result_len < 0) {
    LOG(ERROR) << "ConvertFromBinaryBuffer::Invalid binary data.";
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromBinaryBuffer::Conversion is unsupported for sql_type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromBitBuffer(DataBuffer src_data,
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromBitBuffer::Conversion is unsupported for sql_type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromDateBuffer(DataBuffer src_data,
  ...
  if (src_val.year < 0 || src_val.month < 1 || src_val.month > 12 ||
    ...
    LOG(ERROR) << "ConvertFromDateBuffer::Invalid Date data.";    
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromDateBuffer::Conversion is unsupported for sql_type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromTimeBuffer(DataBuffer& src_data,
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromTimeBuffer::Conversion is unsupported for sql_type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
  ...
  switch (sql_type) {
    ...
    case SQL_INTERVAL_MONTH: {
      if (interval_struct.interval_type != SQL_IS_MONTH) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Month Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_YEAR_TO_MONTH: {
      if (interval_struct.interval_type != SQL_IS_YEAR_TO_MONTH) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Year To Month Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_MINUTE: {
      if (interval_struct.interval_type != SQL_IS_MINUTE) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Minute Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_SECOND: {
      if (interval_struct.interval_type != SQL_IS_SECOND) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Second Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_DAY_TO_HOUR: {
      if (interval_struct.interval_type != SQL_IS_DAY_TO_HOUR) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Day To Hour Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_DAY_TO_MINUTE: {
      if (interval_struct.interval_type != SQL_IS_DAY_TO_MINUTE) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Day To Minute Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_DAY_TO_SECOND: {
      if (interval_struct.interval_type != SQL_IS_DAY_TO_SECOND) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Day To Second Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_HOUR_TO_MINUTE: {
      if (interval_struct.interval_type != SQL_IS_HOUR_TO_MINUTE) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Hour To Minute Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_HOUR_TO_SECOND: {
      if (interval_struct.interval_type != SQL_IS_HOUR_TO_SECOND) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Hour To Second Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    case SQL_INTERVAL_MINUTE_TO_SECOND: {
      if (interval_struct.interval_type != SQL_IS_MINUTE_TO_SECOND) {
        LOG(ERROR) << "ConvertFromIntervalBuffer::Invalid Minute To Second Interval value.";
        return StatusRecord{SQLStates::k_HY000(),
    ...
    default:
      LOG(WARNING) << "ConvertFromIntervalBuffer::Conversion is unsupported for sql_type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromTimestampBuffer(DataBuffer& src_data,
  ...
  if (!src_val || !src_data.result_len || *src_data.result_len < 0) {
    LOG(ERROR) << "ConvertFromTimestampBuffer::Data value is not a valid timestamp.";
    return StatusRecord{SQLStates::k_HY000(),
  ...
  switch (sql_type) {
    ...
    default:
      LOG(WARNING) << "ConvertFromTimestampBuffer::Conversion is unsupported for sql_type: " << sql_type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
  }
}
...
StatusRecordOr<std::string> ConvertFromBuffer(DataBuffer& src_data,
  ...
  switch (src_data.type) {
    ...
    case SQL_C_CHAR: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromCharBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_FLOAT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLREAL>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_DOUBLE: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLDOUBLE>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_SBIGINT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLBIGINT>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_UBIGINT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLUBIGINT>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    ...
    case SQL_C_SSHORT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLSMALLINT>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_USHORT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLUSMALLINT>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    ...
    case SQL_C_SLONG: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLINTEGER>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_ULONG: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLUINTEGER>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_BIT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromBitBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_BINARY: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromBinaryBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_STINYINT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLSCHAR>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    ...
    case SQL_C_UTINYINT: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromArithmeticValue<SQLCHAR>:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_NUMERIC: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromNumericBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_TYPE_DATE: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromDateBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_TYPE_TIME: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromTimeBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    ...
    case SQL_C_INTERVAL_MINUTE_TO_SECOND: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromIntervalBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    case SQL_C_TYPE_TIMESTAMP: {
      ...
      if (!conv_status) {
        LOG(ERROR) << "ConvertFromBuffer::ConvertFromTimestampBuffer:: " << conv_status.GetStatusRecord().message;
        return conv_status.GetStatusRecord();
      }
      return *conv_status;
    }
    default: {
      LOG(WARNING) << "ConvertFromBuffer::Conversion is unsupported for C-type: " << src_data.type;
      return StatusRecord{SQLStates::k_HY000(), "Conversion is unsupported"};
    }
  }
  return StatusRecord::Ok();
