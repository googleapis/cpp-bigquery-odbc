...
public:
  ...
  static StatusOr<std::unique_ptr<ODBCBQClient>> Create(Auth const& auth);
...
private:
  ...
  DatasetClient dataset_client_;
  JobClient job_client_;
  ProjectClient project_client_;
