...
TEST_P(SQLBindParameterTest, BindStandardTypes) {
  ...
  if (is_exec_direct) {
    table_name = kDatasetWithTablePrefix + "ODBC_BIND_PARAM_EXEC_DIRECT_TEST";
  } else {
    table_name = kDatasetWithTablePrefix + "ODBC_BIND_PARAM_EXEC_TEST";
  }
