...
std::vector<StructTestStruct> const kConversionFromStructTestData{
    {SQL_C_CHAR,   {12345, 3.14, "Test String 1", std::vector<int>{1, 2, 3}}, SQL_SUCCESS},
    {SQL_C_WCHAR,  {-99999, 42.42, "Negative Test", std::vector<int>{5, 2, 8}}, SQL_SUCCESS},
    {SQL_C_BINARY, {0, 0.0, "Empty String", std::nullopt}, SQL_SUCCESS},
    {SQL_C_FLOAT,  {123, 1.23, "Float Test", std::nullopt}, SQL_ERROR},
    ...
    {SQL_C_SSHORT, {32767, 12.34, "Short Test", std::nullopt}, SQL_ERROR},
    {SQL_C_USHORT, {65535, 56.78, "UShort Test", std::nullopt}, SQL_ERROR},
    {SQL_C_SLONG,  {2147483647, 9.99, "SLong Test", std::nullopt}, SQL_ERROR},
    {SQL_C_ULONG,  {4294967295, 8.88, "ULong Test", std::nullopt}, SQL_ERROR},
    {SQL_C_BIT,    {1, 0.0, "Bit Test", std::nullopt}, SQL_ERROR},
    {SQL_C_STINYINT, {127, 2.2, "TinyInt Test", std::nullopt}, SQL_ERROR},
    {SQL_C_UTINYINT, {255, 3.3, "UTinyInt Test", std::nullopt}, SQL_ERROR},
    {SQL_C_SBIGINT, {9223372036854775807LL, 4.4, "BigInt Test", std::nullopt}, SQL_ERROR},
    {SQL_C_UBIGINT, {9223372036854775807LL, 5.5, "UBigInt Test", std::nullopt}, SQL_ERROR},
    {SQL_C_NUMERIC, {123, 6.7, "Numeric Test", std::nullopt}, SQL_ERROR},
    {SQL_C_TYPE_DATE, {2024, 7.7, "Date Test", std::nullopt}, SQL_ERROR},
    {SQL_C_TYPE_TIME, {0, 8.8, "Time Test", std::nullopt}, SQL_ERROR},
    {SQL_C_TYPE_TIMESTAMP, {0, 9.9, "Timestamp Test", std::nullopt}, SQL_ERROR},
    {SQL_C_INTERVAL_YEAR, {0, 0.0, "Interval Year", std::nullopt}, SQL_ERROR},
    {SQL_C_INTERVAL_DAY_TO_SECOND, {0, 0.0, "Interval Day Second", std::nullopt}, SQL_ERROR},
};
