...
std::vector<DateTimeBasicTestStruct> const kConversionFromDateTimeTestData{
    ...
    {SQL_C_TYPE_DATE, {2024, 4, 20, 10, 21, 3, 123112}, SQL_SUCCESS},
    {SQL_C_TYPE_TIME, {2024, 5, 20, 10, 2, 30, 123112}, SQL_SUCCESS},
    {SQL_C_TYPE_TIMESTAMP, {2024, 6, 20, 11, 2, 30, 12311}, SQL_SUCCESS},
    {SQL_C_SLONG, {2024, 1, 20, 10, 20, 30, 123112}, SQL_ERROR},
    {SQL_C_DOUBLE, {2024, 1, 20}, SQL_ERROR},
    {SQL_C_CHAR, {2024, 2, 20}, SQL_SUCCESS},
    {SQL_C_USHORT, {2024, 6, 20}, SQL_ERROR},
};
