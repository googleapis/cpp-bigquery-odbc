...
std::vector<DateTimeBasicTestStruct> const kConversionFromDateTimeTestData{
    ...
    {SQL_C_TYPE_DATE, {2024, 4, 20, 11, 2, 33, 12122}, SQL_SUCCESS},
    {SQL_C_TYPE_TIME, {2024, 5, 20, 12, 2, 3, 121233}, SQL_SUCCESS},
    {SQL_C_TYPE_TIMESTAMP, {2024, 6, 20, 14, 2, 33, 12133}, SQL_SUCCESS},
    {SQL_C_SLONG, {2024, 1, 20, 11, 2, 33, 12121}, SQL_ERROR},
    {SQL_C_DOUBLE, {2024, 1, 20}, SQL_ERROR},
    {SQL_C_CHAR, {2024, 2, 20}, SQL_SUCCESS},
    {SQL_C_USHORT, {2024, 6, 20}, SQL_ERROR},
};
