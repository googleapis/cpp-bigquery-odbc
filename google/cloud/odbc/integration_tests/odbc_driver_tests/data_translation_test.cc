...
std::vector<IntervalBasicTestStruct> const kConversionYearMonthIntervalTestData{
    ...
    {SQL_C_INTERVAL_YEAR,  MakeYearMonthInterval(SQL_IS_YEAR,   5, 0), SQL_SUCCESS},
    {SQL_C_INTERVAL_MONTH, MakeYearMonthInterval(SQL_IS_MONTH,  0, 8), SQL_SUCCESS},
    {SQL_C_DOUBLE,         MakeYearMonthInterval(SQL_IS_YEAR,   9, 0), SQL_ERROR},
    {SQL_C_WCHAR,          MakeYearMonthInterval(SQL_IS_YEAR_TO_MONTH, 2, 5), SQL_SUCCESS},
...
std::vector<IntervalBasicTestStruct> const kConversionDaySecondIntervalTestData{
    ...
    {SQL_C_WCHAR,  MakeDaySecondInterval(SQL_IS_HOUR, 0, 2, 0, 0, 0), SQL_SUCCESS},
    {SQL_C_INTERVAL_DAY,
                   MakeDaySecondInterval(SQL_IS_DAY, 15, 0, 0, 0, 0), SQL_SUCCESS},
    {SQL_C_FLOAT,  MakeDaySecondInterval(SQL_IS_MINUTE, 0, 0, 45, 0, 0), SQL_ERROR},
    {SQL_C_INTERVAL_HOUR,
                   MakeDaySecondInterval(SQL_IS_HOUR, 0, 20, 0, 0, 0), SQL_SUCCESS},
    ...
    {SQL_C_DOUBLE, MakeDaySecondInterval(SQL_IS_DAY_TO_HOUR, 10, 14, 0, 0, 0), SQL_ERROR},
    ...
    {SQL_C_INTERVAL_DAY_TO_SECOND,
                   MakeDaySecondInterval(SQL_IS_DAY_TO_SECOND, 2, 1, 2, 20, 500), SQL_SUCCESS},
    {SQL_C_INTERVAL_HOUR_TO_MINUTE,
                   MakeDaySecondInterval(SQL_IS_HOUR_TO_MINUTE, 0, 9, 45, 0, 0), SQL_SUCCESS},
    {SQL_C_INTERVAL_HOUR_TO_SECOND,
                   MakeDaySecondInterval(SQL_IS_HOUR_TO_SECOND, 0, 11, 10, 25, 0), SQL_SUCCESS},
    {SQL_C_BIT,    MakeDaySecondInterval(SQL_IS_DAY_TO_SECOND, 2, 1, 2, 20, 500), SQL_ERROR},
    {SQL_C_INTERVAL_MINUTE_TO_SECOND,
                   MakeDaySecondInterval(SQL_IS_MINUTE_TO_SECOND, 0, 0, 50, 10, 100), SQL_SUCCESS},
};

std::vector<IntervalBasicTestStruct> const kConversionFromSinglePrecisionIntervalData{
    {SQL_C_STINYINT, MakeYearMonthInterval(SQL_IS_YEAR, 1, 0), SQL_SUCCESS},
    {SQL_C_UTINYINT, MakeDaySecondInterval(SQL_IS_DAY, 6, 0, 0, 0, 0), SQL_SUCCESS},
    {SQL_C_SSHORT,   MakeDaySecondInterval(SQL_IS_HOUR, 0, 12, 0, 0, 0), SQL_SUCCESS},
    {SQL_C_USHORT,   MakeDaySecondInterval(SQL_IS_MINUTE, 0, 0, 20, 0, 0), SQL_SUCCESS},
    {SQL_C_ULONG,    MakeDaySecondInterval(SQL_IS_DAY, 4, 0, 0, 0, 0), SQL_SUCCESS},
    {SQL_C_SBIGINT,  MakeDaySecondInterval(SQL_IS_HOUR, 0, 3, 0, 0, 0), SQL_SUCCESS},
