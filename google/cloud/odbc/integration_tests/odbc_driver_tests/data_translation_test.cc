...
std::vector<IntervalBasicTestStruct> const kConversionFromIntervalTestData{
    ...
    {SQL_C_INTERVAL_DAY,
     ...
     SQL_SUCCESS},
    // {SQL_C_INTERVAL_HOUR, {SQL_IS_HOUR, 1, {.day_second = {0, 20, 0, 0, 0}}},
    // SQL_SUCCESS},
    {SQL_C_INTERVAL_MINUTE,
     {SQL_IS_MINUTE, 1, {.day_second = {0, 0, 45, 0, 0}}},
     SQL_SUCCESS},
    // {SQL_C_INTERVAL_SECOND,{SQL_IS_SECOND, 1, {.day_second = {1, 2, 0, 30,
    // 0}}}, SQL_SUCCESS}, {SQL_C_INTERVAL_YEAR_TO_MONTH, {SQL_IS_YEAR_TO_MONTH,
    // 1, {.year_month = {2, 5}}}, SQL_SUCCESS}, {SQL_C_INTERVAL_DAY_TO_HOUR,
    // {SQL_IS_DAY_TO_HOUR, 1, {.day_second = {10, 14, 0, 0, 0}}}, SQL_SUCCESS},
    // {SQL_C_INTERVAL_DAY_TO_MINUTE, {SQL_IS_DAY_TO_MINUTE, 1,{.day_second =
    // {5, 0, 30, 0, 0}}}, SQL_SUCCESS}, {SQL_C_INTERVAL_DAY_TO_SECOND,
    // {SQL_IS_DAY_TO_SECOND, 1,{.day_second = {2, 0, 0, 20, 500}}},
    // SQL_SUCCESS}, {SQL_C_INTERVAL_HOUR_TO_MINUTE, {SQL_IS_HOUR_TO_MINUTE, 1,
    // {.day_second = {0, 9, 45, 0, 0}}}, SQL_SUCCESS},
    // {SQL_C_INTERVAL_HOUR_TO_SECOND, {SQL_IS_HOUR_TO_SECOND,  1, {.day_second
    // = {0, 11, 0, 25,300}}}, SQL_SUCCESS}, {SQL_C_INTERVAL_MINUTE_TO_SECOND,
    // {SQL_IS_MINUTE_TO_SECOND, 1, {.day_second = {0, 0, 50, 10,100}}},
    // SQL_SUCCESS}, {SQL_C_INTERVAL_YEAR, {SQL_IS_YEAR, 1, {.year_month = {3,
    // 0}}}, SQL_SUCCESS}, {SQL_C_INTERVAL_SECOND, {SQL_IS_SECOND, 1,
    // {.day_second = {0, 0, 0, 30, 0}}}, SQL_SUCCESS},
};
  ...
  for (auto const& expected : kConversionFromIntervalTestData) {
    ...
    switch (expected.target_c_type) {
      ...
      case SQL_C_INTERVAL_DAY: {
        tagSQL_INTERVAL_STRUCT* returned_val =
            reinterpret_cast<tagSQL_INTERVAL_STRUCT*>(data_char);
        auto expected_val = expected.interval_value.intval;
      ...
      case SQL_C_INTERVAL_DAY_TO_SECOND: {
        ...
        EXPECT_EQ(expected_val.day_second.second,
                  returned_val->intval.day_second.second);
        EXPECT_EQ(expected_val.day_second.fraction,
                  returned_val->intval.day_second.fraction);
        break;
      }
