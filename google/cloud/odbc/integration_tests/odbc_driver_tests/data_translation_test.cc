...
std::vector<StructTestStruct> const kConversionFromStructTestData{
    {SQL_C_CHAR,
     {12345, 3.14, "Test String 1", L"",
      std::optional<std::vector<int>>{std::vector<int>{1, 2, 3}}},
     SQL_SUCCESS},
    {SQL_C_WCHAR,
     {-99999, 42.42, "Negative Test", L"",
      std::optional<std::vector<int>>{std::vector<int>{5, 2, 8}}},
     SQL_SUCCESS},
    {SQL_C_BINARY, {0, 0.0, "Empty String", L"", std::nullopt}, SQL_SUCCESS},
    {SQL_C_DOUBLE,
     {99999, 100.1, "Positive Test", L"", std::nullopt},
     SQL_ERROR},
    {SQL_C_SHORT, {29, 29.29, "Test String 2", L"", std::nullopt}, SQL_ERROR},
    {SQL_C_LONG,
     {6290, 2.71, "Another String 2", L"", std::nullopt},
     SQL_ERROR},
    {SQL_C_TYPE_DATE, {78, 89.9, "Error", L"", std::nullopt}, SQL_ERROR},
    {SQL_C_BIT, {67890, -2.71, "Another String", L"", std::nullopt}, SQL_ERROR},
};
