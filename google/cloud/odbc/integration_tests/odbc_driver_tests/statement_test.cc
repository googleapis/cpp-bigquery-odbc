...
void PutAllDataTypes(std::shared_ptr<ODBCHandles> conn,
  ...
  DataField fields[] = {
      ...
      {&int_data, sizeof(int_data), SQL_C_SLONG, SQL_INTEGER, &int_len},
...
void ValidateAllPutData(std::shared_ptr<ODBCHandles> conn,
  ...
  DataField validations[] = {
      ...
      {&result_int, sizeof(result_int), SQL_C_SLONG, SQL_INTEGER,
       &result_int_len},
...
TEST(StatementTest, SQLPutDataMultipleDataTypes) {
  ...
  std::cout << "========sizeof(SQL_INTEGER)" << sizeof(SQL_INTEGER)
            << std::endl;
