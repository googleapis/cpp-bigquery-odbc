...
**Does this issue affect the cpp-bigquery-odbc project?**
If the problem is with the Google Cloud service exposed by the `cpp-bigquery-odbc` libraries instead of the client libraries themselves, you may consider opening a support request instead. The `cpp-bigquery-odbc` developers cannot help you troubleshoot problems with the service itself.

**What component of `cpp-bigquery-odbc` is this related to?**
...
**What version of `cpp-bigquery-odbc` are you using?**
